<template>
  <div class="app-container">
    <el-form
      ...
      label-width="68px"
    >
      <el-form-item label="商机名称" prop="configName">
        <el-input
      ...
      <el-form-item label="所有者" prop="configKey">
        <el-input
          v-model="queryParams.configKey"
    ...
    >
      ...
      <el-table-column label="商机编号" align="center" prop="configId" />
      <el-table-column
        label="商机名称"
        align="center"
        prop="configName"
      ...
      <el-table-column
        ...
        :show-overflow-tooltip="true"
      />
      <el-table-column label="当前阶段" align="center" prop="configValue" />
      <el-table-column label="所有者" align="center" prop="configType"/>
      <el-table-column
        label="投标时间"
        align="center"
        prop="createTime"
