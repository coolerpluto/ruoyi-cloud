<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="shareconfigList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="共享源" align="center" prop="sourceIds" v-if="columns[1].visible"/>
      ...
      <el-table-column label="共享目标" align="center" prop="targetIds" v-if="columns[3].visible"/>
      ...
      <el-table-column label="共享失效时间" align="center" prop="expTime" v-if="columns[6].visible"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="1000px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="共享源" prop="sourceIds">
              <!--需要区分资源类型， 是人员还是部门-->
              <el-input v-model="form.sourceIds" placeholder="请输入参数名称"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="共享目标" prop="targetIds">
              <!--需要区分资源类型， 是人员还是部门-->
              <el-input v-model="form.targetIds" placeholder="请输入参数名称"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
