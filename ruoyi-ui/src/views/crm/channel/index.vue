<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="companyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="渠道编码" align="center" prop="code" v-if="columns[6].visible"
    ...
    <el-dialog :title="title" :visible.sync="open" width="80%" :close-on-click-modal="false" append-to-body>
      ...
      <div id="stepsArea" v-if="baseCompanyReadOnly">
        ...
        <div id="channelContactArea" v-if="companyDetailActive===2">
          ...
          <pagination v-show="channelContactTotal>0" :pageSizes="[4,6,8]"
                      :total="channelContactTotal"
                      :page.sync="queryChannelContactParams.pageNum"
                      :limit.sync="queryChannelContactParams.pageSize"
        ...
        <div id="channelAppArea" v-if="companyDetailActive===3">
          ...
          <pagination v-show="channelAppTotal>0" :pageSizes="[4,6,8]" :total="channelAppTotal"
                      :page.sync="queryChannelAppParams.pageNum"
                      :limit.sync="queryChannelAppParams.pageSize"
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {key: 2, label: `行业归属`, visible: false},
        {key: 3, label: `公司法人`, visible: false},
        {key: 4, label: `注册资金`, visible: true},
        {key: 5, label: `缴纳方式`, visible: false},
        {key: 6, label: `渠道编码`, visible: true},
        {key: 7, label: `公司官网`, visible: true},
        {key: 8, label: `地址代号`, visible: true},
