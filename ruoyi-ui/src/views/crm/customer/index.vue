<template>
  <div class="app-container">
    <el-form :model="queryParams"
      ...
      <el-form-item label="行业大类" prop="industryType">
        <el-select
        ...
        >
          <el-option
            v-for="item in dict.type.crm_industry_type"
            :key="item.value"
            :label="item.label"
            :value="item.value"
          >
      ...
      <el-form-item label="二级行业" prop="industryType">
        <el-select
          v-model="queryParams.industryType"          
          collapse-tags
          style="width: 200px"
      ...
      <el-form-item label="三级行业" prop="industryType">
        <el-select
          v-model="queryParams.industryType"          
          collapse-tags
          style="width: 200px"
    ...
    >
      ...
      />
      <el-table-column label="用户地址" align="center" prop="configValue" />
      <el-table-column label="行业所属" align="center" prop="configValue" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="1000px" append-to-body>
      <el-row :gutter="15">
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          <el-col :span="24">
            <el-form-item label="用户名称" prop="customerName">
            <el-input v-model="form.customerName" placeholder="请输入参数名称" />
          </el-form-item>
          </el-col>          
          <el-col :span="8">
