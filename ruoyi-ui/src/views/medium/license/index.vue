<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="licenseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="生成Lic系统" align="center" prop="buildLicSystem" :show-overflow-tooltip="true" v-if="columns[15].visible"/>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding" min-width="100%">
        <template slot-scope="scope">
          <el-button
            size="mini"
            type="text"
