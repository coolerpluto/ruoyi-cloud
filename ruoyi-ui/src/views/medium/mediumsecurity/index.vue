...
<script>
import { listMediumsecurity, getMediumsecurity, delMediumsecurity, addMediumsecurity, updateMediumsecurity } from "@/api/medium/mediumsecurity";
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateMediumsecurity(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addMediumsecurity(this.form).then(response => {
